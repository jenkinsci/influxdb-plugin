...
public class SonarQubePointGenerator extends AbstractPointGenerator {
    ...
    private void setSonarDetails(String sonarBuildURL) {
        ...
        if (credentialId != null) {
            String logMessage = "[InfluxDB Plugin] INFO: Using SonarQube credentials found in environment variable SONAR_AUTH_TOKEN";
            listener.getLogger().println(logMessage);
    ...
    public static StringCredentials findSonarqubeCredentials(String credentialsId, ItemGroup<?> itemGroup) {
