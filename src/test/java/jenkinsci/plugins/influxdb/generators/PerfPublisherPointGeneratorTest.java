...
public class PerfPublisherPointGeneratorTest {
    ...
    public void generate() {
        ...
        try (MockedStatic<Jenkins> instance = Mockito.mockStatic(Jenkins.class)) {
            ...
            assertTrue(points[0].toLineProtocol().startsWith("perfpublisher_summary,instance=http://jenkinsurl:8080,prefix=test_prefix,project_name=test_prefix_master,project_namespace=folder,project_path=folder/master build_number=11i,number_of_executed_tests=1i"));
            assertTrue(points[1].toLineProtocol().startsWith("perfpublisher_metric,instance=http://jenkinsurl:8080,prefix=test_prefix,project_name=test_prefix_master,project_namespace=folder,project_path=folder/master average=50.0,best=50.0,build_number=11i,metric_name=\"metric1\",project_name=\"test_prefix_master\",project_path=\"folder/master\",worst=50.0"));
            assertTrue(points[2].toLineProtocol().startsWith("perfpublisher_test,instance=http://jenkinsurl:8080,prefix=test_prefix,project_name=test_prefix_master,project_namespace=folder,project_path=folder/master,test_name=test.txt build_number=11i,executed=true,project_name=\"test_prefix_master\",project_path=\"folder/master\",successful=false,test_name=\"test.txt\""));
            assertTrue(points[3].toLineProtocol().startsWith("perfpublisher_test_metric,instance=http://jenkinsurl:8080,prefix=test_prefix,project_name=test_prefix_master,project_namespace=folder,project_path=folder/master,test_name=test.txt build_number=11i,metric_name=\"metric1\",project_name=\"test_prefix_master\",project_path=\"folder/master\",relevant=true,test_name=\"test.txt\",unit=\"ms\",value=50.0"));
        }
    }
}
